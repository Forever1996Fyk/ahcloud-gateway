...
public enum RpcTypeEnum {
    ...
    /**
     * acquire operator support Route RPC type.
     *
     * @return operator support.
     */
    public static List<RpcTypeEnum> acquireSupportRoutes() {
    ...
    public static RpcTypeEnum acquireByName(final String name) {
        return Arrays.stream(RpcTypeEnum.values())
            ...
            .orElseThrow(() -> new RuntimeException(String.format(" this rpc type can not support %s", name)));
    }
}
