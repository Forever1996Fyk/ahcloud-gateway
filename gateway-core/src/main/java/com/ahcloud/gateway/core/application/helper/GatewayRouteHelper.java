...
public class GatewayRouteHelper {
    ...
    public static List<RouteDefinitionDTO> buildRoutes(List<GatewayApi> gatewayApiList) {
        return gatewayApiList.stream()
                .map(GatewayRouteHelper::buildRoute)
    ...
    public static GatewayRouteDefinition convert(RouteDefinitionDTO routeDefinitionDTO) {
        GatewayRouteDefinition gatewayRouteDefinition = Convert.INSTANCE.convert(routeDefinitionDTO);
        gatewayRouteDefinition.setCreator("SYSTEM");
        gatewayRouteDefinition.setModifier("SYSTEM");
    ...
    public interface Convert {
        ...
        @Mappings({
                ...
                @Mapping(target = "predicateDefinitionConfig", expression = "java(com.ahcloud.common.utils.JsonUtils.toJsonString(routeDefinitionDTO.getPredicates()))"),
                @Mapping(target = "filterDefinitionConfig", expression = "java(com.ahcloud.common.utils.JsonUtils.toJsonString(routeDefinitionDTO.getFilters()))"),
                @Mapping(target = "uri", expression = "java(String.valueOf(routeDefinitionDTO.getUri()))")
        })
        GatewayRouteDefinition convert(RouteDefinitionDTO routeDefinitionDTO);
    }
}
