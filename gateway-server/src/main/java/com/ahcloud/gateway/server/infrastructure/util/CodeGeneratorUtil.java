//package com.ahcloud.gateway.server.infrastructure.utils;
//
...
//
//        //todo 需要生成的表
//        String[] tables = new String[]{"gateway_route", "gateway_route_predicate", "gateway_route_filter"};
//
//
//        //代码生成器
...
//        dsc.setUrl("jdbc:mysql://localhost:3306/gateway?nullCatalogMeansCurrent=true&serverTimezone=UTC&useUnicode=true&characterEncoding=UTF-8&useSSL=false")
